...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #D6ED17FF;">
      ...
      <!-- Activity section -->
            <div class="row activity text-center" style="background-color : #606060FF;">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Nishank majumdar</b> 
      </footer>
